	...
	*/
		...
		if (($func == "thumb") or ($func == "preview"))
		{
			...
			else
			{
				...
				if (($func == "thumb") and ($image_dir != "_sfpg_icons/"))
				{
					...
					if (WATERMARK)
					{
						$wm_file = GALLERY_ROOT . "sfpg_icons/" . WATERMARK;
	...
	function sfpg_javascript()
	{
		...
		function showMenu()
		{
			...
			echo "menu += '<span onmouseover=\"this.className=\'sfpg_button_hover\';\" onmouseout=\"this.className=\'sfpg_button\';\" class=\"sfpg_button\" onclick=\"window.location=\'logout.php\'\">Logout</span>';
